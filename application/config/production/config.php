...
|
*/
$config['base_url'] = 'https://biz.vayzn.com/';
...
$config['csrf_exclude_uris'] = array('login/authenticate_user', 'sign-up/resendEmail', 'bids/store' , 'register/store');
...
$config['resources_abs_path'] = $_SERVER['DOCUMENT_ROOT']."/../resources.vayzn.com/";

$config['base_resources_url'] = "https://resources.vayzn.com/";
