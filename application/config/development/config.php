...
|
*/
$config['base_url'] = 'http://localhost:81/bid/public_html/';
...
|
*/
$config['encryption_key'] = 'NM"S.OOUL%b/XWSk74~X2y~bz(}cP<';
...
$config['sess_save_path'] = 'ssx_ci_sessions';
...
$config['csrf_exclude_uris'] = array('login/authenticate_user', 'sign-up/resendEmail', 'profile/storeAuction', 'bids/store');
...
$config['resources_abs_path'] = $_SERVER['DOCUMENT_ROOT']."/resources/";

$config['base_resources_url'] = "http://localhost:81/resources/";
