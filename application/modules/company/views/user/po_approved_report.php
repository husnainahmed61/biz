...
<div class="transaction-list">
	...
	<!-- /TRANSACTION LIST HEADER -->
	<?php foreach ($approved_po as $key => $value) { ?>
	...
	<div class="transaction-list-item">
		...
		<div class="transaction-list-item-item">
			<p class="category primary"><a href=""><?=$value['cur'].' '.$value['qty'].' '.$value['qty_unit']?></a></p>
		</div>
		<div class="transaction-list-item-detail">
			<p><?=$value['warehouse']?></p>
		</div>
		<div class="transaction-list-item-code">
			<p><span class="light"><?=$value['delivery_date']?></span></p>
		</div>
		<div class="transaction-list-item-price">
			<p><?=$value['shipment_details']?></p>
		</div>
