                                                ...
                                                <div class="content">
                                                    <div class="header" >
                                                        <div class="post-title">
                                                            <h4><a href="<?= base_url('products/1') ?>"> Strategies for
                                                                    Acquiring
                                                                    Your Own
                                                                    Laptop </a>
                                                            </h4>
                                                    ...
                                                    <div class="description">
                                                        <p class="">
                                                            ...
                                                            advanced mobile processors from Intel, Latest Intel mobile
                                                            architecture Powered by the most
                                                    ...
                                                    <h3 class="price" itemprop="offers" itemscope
                                                        ...
                                                        <span class="price-new" itemprop="price">$ 1,400</span>
                                                    ...
                                                    <div class="button-group">
                                                        <!--<button data-load-url="<?/*= base_url("/products/quickview/1"); */?>"
                                                        ...
                                                        <div class="add-to-links">
                                                            ...
                                                            <label class="label label-default bid-status" data-toggle="tooltip"
                                                                    title="Bid Status"
                                                                    onClick="">
                                                                Pending</label>
                                                            <label class="label label-danger bid-status" data-toggle="tooltip"
                                                                   title="Bid Status"
                                                                   onClick="">
                                                                Reject</label>

                                                            <label class="label label-success bid-status" data-toggle="tooltip"
                                                                   title="Bid Status"
                                                                   onClick="">
                                                                Accepted</label>
                                                ...
                                                <div>
                                                    <div class="caption">
                                                        ...
                                                        <p class="description">
                                                            ...
                                                            advanced mobile processors from Intel, Latest Intel mobile
                                                            architecture Powered by the most
                                                            advanced mobile processors from Intel,
                                                        ...
                                                        <h3 class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                                            <span class="price-new" itemprop="price" data-toggle="tooltip"
                                                                  title="Current Bid" >$ 1,400</span>
                                                            <span class="price-old" itemprop="price" data-toggle="tooltip"
                                                                  title="Start Price">$ 1,400</span>
                                                            <span itemprop="availability" content="In Stock"></span>
                                                        </h3>
                                                    </div>
                                                    <div class="button-group">
                                                        <button data-load-url="<?= base_url("/myposts/quickview/1"); ?>"
                                                                class="btn btn-primary buy-now" data-toggle="tooltip"
                                                                title="Quick View">
                                                            <span>Bids</span>
                                                        </button>
...
<div class="modal fade" id="bid-details-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
