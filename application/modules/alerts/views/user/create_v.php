            ...
            <div class="col-xl-9 col-12">
                <div class="form-box-items left full-width">
                    ...
                    <div class="form-box-item">
                        ...
                        <div class="">
                            <form id="alert_add" class="row create-auction-form" method="POST" action="<?= base_url('alerts/store')?>" enctype="multipart/form-data">
                                <!-- INPUT CONTAINER -->
                                <!-- INPUT CONTAINER -->
                                <div class="input-container col-xs-12 radio-btn-cs">
                                    <label class="rl-label required">Ad Type </label>
                                    <!-- RADIO -->
                                    <input type="radio" id="paypal" name="mode" value="sell" checked>
                                    <label for="paypal">
                                    ...
                                    <!-- RADIO -->
                                    <input type="radio" id="skrill" name="mode" value="buy">
                                    <label for="skrill">
                                        <span class="radio primary"><span></span></span>
                                        Buying Post
                                    </label>
                                ...
                                <div class="input-container col-xs-12 radio-btn-cs">
                                    ...
                                    <!-- RADIO -->
                                    <input type="checkbox" id="r3" name="type[]" value="email" checked>
                                    <label for="r3">
                                    ...
                                    <!-- RADIO -->
                                    <input type="checkbox" id="r1" name="type[]" value="sms">
                                    <label for="r1">
                                        <span class="checkbox primary"><span></span></span>
                                        SMS
                                    </label>
