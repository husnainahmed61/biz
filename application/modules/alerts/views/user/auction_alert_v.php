                        ...
                        <form id="shop_filter_form" name="shop_filter_form">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 box">
                                    <label for="itemspp_filter" class="select-block">
                                        <select name="itemspp_filter" id="input_post_type_view">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 box">
                                    <label for="input-sort-view" class="select-block">
                                        <select id="input-sort-view">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 box">
                                    <label for="itemspp_filter" class="select-block">
                                        <select name="itemspp_filter" id="input-currency-view">
