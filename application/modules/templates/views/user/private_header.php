        ...
        <div class="dashboard-header retracted">
            ...
            <div class="db-options-button">
               <img src="<?=base_url();?>assets_u/images/dashboard/db-list-right.png" alt="db-list-right">
               <img src="<?=base_url();?>assets_u/images/dashboard/close-icon.png" alt="close-icon">
            </div>
            <!-- DB OPTIONS BUTTON -->
            ...
            <div class="dashboard-header-item title">
                <!-- DB SIDE MENU HANDLER -->
                 <div class="db-side-menu-handler">
                    <img src="<?=base_url();?>assets_u/images/dashboard/db-list-left.png" alt="db-list-left">
                </div>
                <!-- /DB SIDE MENU HANDLER -->
            ...
            <div class="dashboard-header-item form">
                <form class="dashboard-search">
                    ...
                    <input type="image" src="<?=base_url();?>assets_u/images/dashboard/search-icon.png" alt="search-icon">
                </form>
            </div>
            <!-- /DASHBOARD HEADER ITEM -->
            ...
            <div class="dashboard-header-item stats">
                ...
                <div class="stats-meta">
                    <div class="pie-chart pie-chart11">
                        <!-- SVG PLUS -->
            ...
            <div class="dashboard-header-item back-button">
                <a href="<?=base_url()?>" class="button mid dark-light">Back to Homepage</a>
            </div>
            <!-- /DASHBOARD HEADER ITEM -->
        </div>
        <!-- DASHBOARD HEADER -->
