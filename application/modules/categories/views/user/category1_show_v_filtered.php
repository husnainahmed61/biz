                        ...
                        <div class="product-preview-actions">
                            ...
                            <figure class="product-preview-image">
                                <div class="white_space">
                                    <img src="<?= $base_resources_url . $auction[$image] ?>">
                                </div>
                            </figure>
                            <!-- /PRODUCT PREVIEW IMAGE -->
                        ...
                        <div class="info-wrapper-cs">
                            ...
                            echo $string;?></p>
                                ...
                                <p class="product-description"><?php
                                    ...
                                    echo $string;
                                    ?></p>
                                <a href="<?= base_url() ?><?= $auction['cat_slug'] ?>/category3">
                            ...
                            <div class="user-rating">
                                ...
                                <ul class="rating tooltip" title="Auction Reputation" style="
    position: inherit;
    opacity: 1;
">
                            <?php 
