        ...
        <div class="container">
            <div class="section-headline row">
                ...
                <div class="col-sm-6 s">
                    <p>Categories<span class="separator">/</span><?=$category1Name?><span class="separator">/</span><span class="current-section"><?= $name ?></span></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="content col-12 col-lg-9">
                        ...
                        <!-- PAGER -->
                            ...
                            <ul class="pagination pager primary" id="pagination">
                                </ul>
                        <!-- <div class="">        
