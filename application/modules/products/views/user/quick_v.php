<div itemscope itemtype="http://schema.org/Product">
    ...
    <div class="row product-info">
        <div class="col-sm-4">
            <div class="image">
                <img class="img-responsive" itemprop="image" src="<?= base_url("assets_u/image/product/macbook_air_1-350x350.jpg")?>"
                     title="Laptop Silver black" alt="Laptop Silver black"/>
            </div>
        </div>
        <div class="col-sm-8">
            <ul class="list-unstyled description inline-block">
            ...
            <div class="addthis_toolbox addthis_default_style">
                ...
                <a class="addthis_button_tweet"></a> <a class="addthis_button_google_plusone"
                        ...
                        pi:pinit:media="http://www.addthis.com/cms-content/images/features/pinterest-lg.png"></a> <a
