<script type="text/javascript">
    $(document).ready(function () {
        ...
        var productsDataUrl = base_url + "admin/products/getProductsDatatable";
        var selectedProductsDataUrl = base_url + "admin/products/getDatatable/";

        var $productTable = $('#products_table');
