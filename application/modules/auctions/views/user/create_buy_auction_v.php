...
<!--<option value="1" selected >Dev Cat 1</option>-->
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group required mb-lg">
...
<!--                                        <div class="form-group required">
                                        ...
                                        <input type="hidden" class="form-control" id="input-base_price"
                                                       placeholder="Base Price" value="0" name="base_price" />
                                        <div class="form-group">
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" id="input-lastname"
                                                       placeholder="Last Name" value="2025-07-20" name="expires_at" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="range-inputs" style="display: none;">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" min="0" class="form-control" id="input-maximum"
                    ...
                    <div id="step-2" class="">
                        <form id="form_step_2"  method="GET" class="form-horizontal" action="<?= base_url('auctions/storeAuction')?>" enctype="multipart/form-data">
...
<!-- share modal -->
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="share-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
